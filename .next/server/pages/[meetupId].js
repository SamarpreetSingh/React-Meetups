...
function MeetupDetail(props) {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])("div", {
    className: MeetupDetail_module_default.a.section,
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://samar:samar@cluster0.edtms.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
  const db = client.db();
...
async function getStaticProps(context) {
  ...
  client.close(); // console.log(selectedMeetup);
